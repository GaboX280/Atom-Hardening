...
class SecuritySummary:
    ...
    def summarize(findings):
        ...
        status = Counter(finding.status.upper() for finding in findings)

        severity = Counter(finding.severity.upper() for finding in findings)
        ...
        for finding in findings:
            ...
            categories[category][finding.status.upper()] += 1
