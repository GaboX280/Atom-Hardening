...
def audit_failed_logins(auditor: BaseAuditor):


    auditor.log(
        "Evaluando intentos fallidos de autenticación..."
    )
    ...
    if encontrado:
        ...
        auditor.add_finding(
            ...
            details=(
                f"Se detectaron {cantidad} intentos fallidos "
                "de autenticación SSH."
            ),
            ...
            impact=(
                "Múltiples intentos fallidos pueden indicar "
        ...
        auditor.add_finding(
            ...
            recommendation=(
                "Mantener monitoreo continuo de logs."
            ),

            reference=(
                "https://man7.org/linux/man-pages/man5/auth.conf.5.html"
            ),
