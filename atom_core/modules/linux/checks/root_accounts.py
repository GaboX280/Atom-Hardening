...
def audit_root_accounts(auditor: BaseAuditor):
    ...
    if usuarios.startswith("ERROR"):
        ...
        auditor.add_finding(
            ...
            details=(
                "No fue posible consultar cuentas con UID 0."
            ),

            recommendation=(
                "Ejecutar la auditoría con permisos suficientes."
            ),
    ...
    if len(cuentas) > 1:
        ...
        auditor.add_finding(
            ...
            details=(
                ...
                f"Se detectaron múltiples cuentas con UID 0: "
                f"{', '.join(cuentas)}"
            ...
            recommendation=(
                ...
                "Mantener únicamente cuentas privilegiadas "
                "necesarias y utilizar sudo."
        ...
        auditor.add_finding(
            ...
            details=(
                ...
                "Solo existe una cuenta con UID 0."

            ),

            recommendation=(

                "Mantener control de privilegios mediante sudo."
