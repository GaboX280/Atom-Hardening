...
def audit_password_policy(auditor: BaseAuditor):


    auditor.log(
        "Evaluando política de expiración de contraseñas..."
    )
    ...
    if resultado.startswith("ERROR"):
        ...
        auditor.add_finding(
            ...
            details=(
                ...
                "No fue posible consultar la política "
            ...
            recommendation=(
                ...
                "Verificar permisos de lectura sobre "
                "/etc/login.defs."
    ...
    if dias is not None and dias <= 90:
        ...
        auditor.add_finding(
            ...
            details=(
                ...
                f"Caducidad máxima configurada: {dias} días."

            ),

            recommendation=(

                "Mantener una política segura de expiración."
            ...
            impact=(
                ...
                "Reduce la ventana de exposición de "
        ...
        auditor.add_finding(
            ...
            recommendation=(
                ...
                "Configurar PASS_MAX_DAYS a un valor menor "
                "o igual a 90 días."
            ...
            impact=(
                ...
                "Contraseñas con larga duración aumentan "
                "el riesgo ante filtraciones."
