...
def audit_guest_account(auditor: BaseAuditor) -> None: # [TIPADO AÑADIDO]

    auditor.log("Evaluando cuenta Invitado...")

    resultado = auditor._run_command(["net", "user", "Invitado"])

    resultado_upper = resultado.upper()

    activa = ("CUENTA ACTIVA" in resultado_upper and "SÍ" in resultado_upper) or (
    ...
    if activa:
        auditor.add_finding(
            ...
            compliance=["CIS Controls v8 - Control 5", "NIST SP 800-53 AC-2"],
        )
